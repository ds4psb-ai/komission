...
**관련 문서**: [ARCHITECTURE_FINAL.md](docs/ARCHITECTURE_FINAL.md), [00_DOCS_INDEX.md](docs/00_DOCS_INDEX.md)
...
| **다국어 지원** | 한국어/영어 UI 토글 (부분 적용) | 진행 중 |
...
| **주요 화면** | `/ops`, `/ops/outliers`, `/ops/canvas` |
...
| **주요 화면** | `/`, `/for-you`, `/remix/[nodeId]`, `/my`, `/wizard` |
...
| Google OAuth + JWT | 사용자 인증 | Firebase Auth는 legacy 설정만 유지 |
...
- `docs/ARCHITECTURE_FINAL.md` - 아키텍처 정합성
