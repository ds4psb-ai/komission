...
| Source | Description |
|--------|-------------|
| [12_PERIODIC_CRAWLING_SPEC.md](docs/12_PERIODIC_CRAWLING_SPEC.md) | Crawler API specs, rate limits, outlier formula |
| [10_VIRLO_BENCHMARK.md](docs/10_VIRLO_BENCHMARK.md) | Virlo IA/feature mapping |
| [07_CANVAS_NODE_CONTRACTS.md](docs/07_CANVAS_NODE_CONTRACTS.md) | Node type definitions |
| [02_EVIDENCE_LOOP_CANVAS.md](docs/02_EVIDENCE_LOOP_CANVAS.md) | VDG sheets + workflow |
| [09_UI_UX_STRATEGY.md](docs/09_UI_UX_STRATEGY.md) | UI principles |
| [ARCHITECTURE_FINAL.md](docs/ARCHITECTURE_FINAL.md) | Final architecture blueprint |
...
## 5) Outlier Score Formula [OBSERVED from 12_PERIODIC_CRAWLING_SPEC]
